...
func (in *ArgocdToken) DeepCopyInto(out *ArgocdToken) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ArgocdToken.
func (in *ArgocdToken) DeepCopy() *ArgocdToken {
	if in == nil {
		return nil
	}
	out := new(ArgocdToken)
